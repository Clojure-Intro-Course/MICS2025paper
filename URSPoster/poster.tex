...
\block{Babel}{
    \begin{itemize}
        ...
        \item Many error messages are replaced directly with simplified, beginner-friendly explanations. \emcomment{versions?}
...
\emcomment{It sounds too simple. Perhaps allude to the level of complexity? Mention that we designed specifications to provide detailed information about the error?}
    \end{itemize}
}
...
\block{Goals for This Year.}{
    \begin{itemize}
        ...
        \item We are aiming to have Morse stylize text based on good design practices for error messages [3]. We are looking to improve formatting and add support for hovering over important terms. \emcomment{Hovering for what purpose? also - including access to resources?}
    \end{itemize}
    }
