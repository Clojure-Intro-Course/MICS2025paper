...
\block{Babel}{
    \begin{itemize}
        ...
        \item Many error messages are replaced directly with simplified, beginner-friendly explanations.
        \item Errors on function calls provide more detailed information about expected arguments: their types, count, etc.
...
\block{Goals for This Year.}{
    \begin{itemize}
        ...
        \item We are aiming to have Morse stylize text based on good design practices for error messages [3]. We are looking to improve formatting and add support for hovering over important terms.
    \end{itemize}
    }
...
%\jscomment{Jaydon's section.}
    \begin{itemize}
        \item We are looking to conduct usability studies on Morse in the future.
        \item We also want to explore integrating Morse viewers into IDEs such as Visual Studio Code for workflow refinements.
        \item We would like to develop more Morse viewers for other information provided in error messages, such as stack traces and Java errors.
    \end{itemize}
}
