...
\tkcomment{Tristan's section}
	...
	\item It emphasizes breaking problems into smaller, manageable pieces and promotes a more declarative programming style. Which is where you tell it what you want to happen rather than giving it a list of steps to follow.
    ...
    \item Clojure is a functional lisp-based language that encourages these principles and is a great tool for introducing students to functional programming.
    \item It has a simple, minimal syntax with prefix notation in statements and statements are surrounded by parenthesis.
    \item it uses an interactive REPL environment
...
\jwcomment{John's section.}
    \begin{itemize}
        \item We would like to refine the internal workings of the tool.
        \item We would like to continue to explore other ways to visualize and organize information about errors, such as adding selective highlighting or similar. 
        \item We would like to continue to explore resources to include in the environment. 
        \item Once we have a more robust set of visualization options, we would like to proceed to refine the interface for beginner developers.
        \item We hope to start looking at the research question 
            \emph{“How can errors be presented so that novice programmers can correct errors most effectively?”}.
    \end{itemize}
}
...
\block{Acknowledgements}{
    We would like to thank Morris Academic Partnership (MAP) for sponsoring this work. We would also like to thank Joe Lane, an employee of Nubank, for being a consultant and advisor as we have been exploring this project and tools. 
}
