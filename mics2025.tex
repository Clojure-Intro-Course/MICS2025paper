...
\subsection{Clojure and its Error Messages}\label{sec:clojure-errs}
...
\subsection{Clojure Spec}\label{sec:spec}
...
\subsection{Classifying Error Messages}\label{sec:classification}
...
\jwcomment{TODO: Find a better title.}

\subsection{Designing an Error Message Interface}\label{sec:interface}
